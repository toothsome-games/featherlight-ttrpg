...
A one-page, 'quick-start' guide to Featherlight is also available on {{< fa brands itch-io >}} itch.io. Check it out for an at-a-glance overview of the fundamental mechanics of Featherlight!
...
Just like the rulebook, this guide is PWYW, but if you can afford $2, that would be awesome and--again, just like the rulebook--would go to support the art I'm commissioning for custom Featherlight settings and quest hooks.

If you like what you see in this guide, consider checking out the full rulebook for useful graphics, more description, and tips for those interested in running a Featherlight game at their table!
...
If you print this at home, do two sheets per standard piece of paper because the sheet is designed to be the size of a postcard (4x6") so two should fit nicely on a 8.5x11" piece of paper.
...
AI tools are trained on stolen intellectual property for which the creators will never be credited or compensated. Because of this, **AI was not used in <u>any</u> facet of this work.** Please respect this by not feeding any _Featherlight_ content (from this website or elsewhere) into those systems. Thanks!
